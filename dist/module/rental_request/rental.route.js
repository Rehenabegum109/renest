...
router.patch("/landlord/requests/:id", auth("LANDLORD"), validateRequest(RentalValidation.updateRentalStatusValidation), RentalController.updateRentalStatus);
router.get("/:id", auth("TENANT"), RentalController.getRentalById);
